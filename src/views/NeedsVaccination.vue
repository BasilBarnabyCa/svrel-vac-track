<template>
	<div class="p-6">
		<h2 class="text-2xl font-semibold mb-4">Needs Vaccination Soon</h2>
...
const fetchHorses = async () => {
	...
	try {
		...
		const response = await axios.get(`http://sm.svrel.test/api/external/jrc/horses/needs-vaccination?page=${currentPage.value}`, {
