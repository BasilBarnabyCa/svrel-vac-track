<template>
	<div class="p-6">
		<h2 class="text-2xl font-semibold mb-4">Requiring Double Boosters</h2>
...
const fetchHorses = async () => {
	...
	try {
		...
		const response = await axios.get(`http://sm.svrel.test/api/external/jrc/horses/requires-double-boosters?page=${currentPage.value}`, {
